...
const storage = employees.map((employee, i) =>
    <div className="card" key={i}>
        <p><span>Nombre</span>: {employee.name}</p>
        <p><span>Apellidos</span>: {employee.lastName}</p>
        <p><span>Hobbies</span>: {employee.hobbies.join(', ')}</p>
        <p><span>Edad</span>: {employee.age}</p>
    </div>)
